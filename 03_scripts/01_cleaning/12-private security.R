...
#   mutate(`2012`=`2011`,`2014`=`2013`,`2015`=`2013`,`2016`=`2013`,`2017`=`2013`,`2018`=`2013`,`2019`=`2013`,`2020`=`2013`, `2021`=`2013`) %>% 
...
# 
# 
# write.csv(tmp, "Private security/private security numbers updated 2021.csv")
# 
# 
